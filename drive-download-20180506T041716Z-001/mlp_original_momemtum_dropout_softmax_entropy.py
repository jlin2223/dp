...
data_sample = np.zeros([3000, data.shape[1]])
data_sample_label = np.zeros(3000)
i = 0
while i < 3000:
...
MSE = nn.fit(input_data, output_data, learning_rate=0.01, epochs=2, lamdb=5, momemtum_rate=0.9,dropout_param={'p':0.5 ,'mode':'train','seed':6})
